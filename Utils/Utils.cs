...
namespace GModMountManager
{
    public static partial class Utils
    {
        ...
        public static Process StartProcess(string file, string workDir = null, params string[] args)
        {
            ...
            LogManager.GetCurrentClassLogger().Debug("Starting Process: {0} {1}", proc.FileName, proc.Arguments);
            if (workDir != null)
            {
                proc.WorkingDirectory = workDir;
                LogManager.GetCurrentClassLogger().Debug("Working Directory: {0}", proc.WorkingDirectory);
            }
